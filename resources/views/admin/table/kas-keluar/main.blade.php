                                ...
                                <div class="box_right d-flex lms_block">
                                    ...
                                    <div class="add_button ms-2">
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#kasmasuk"
                                            class="btn_1">Tambah Kas Keluar</a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table class="table lms_table_active ">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $kas->user->name }}</td>
                                            <td>
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#showkaskeluar{{ $kas->id_kas }}" class="btn btn-info"><i class="ti-eye text_white"></i></a>
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#editkaskeluar{{ $kas->id_kas }}" class="btn btn-warning"><i class="ti-pencil-alt text_white"></i></a>
                                                <form action="{{ route('destroy-kas-keluar', $kas->id_kas) }}" method="post" style="display: inline">
                                                @method('delete')
                                                @csrf
